...
import com.fluidops.iwb.ui.configuration.VoidSelectValuesFactory;
...
public @interface ParameterConfigDoc 
{
	...
	/**
	 * a fully qualified Java class implementing {@link SelectValuesFactory}, which is used
	 * to compute the select values of type := {@link Type#DROPDOWN} at runtime. If 
	 * {@link #selectValues()} are given at the same time, this setting is ignored.
	 * @return
	 */
	 ...
	 * @deprecated not required as list type is extracted from field information
	 */
	@Deprecated
	...
	public static enum Type
	{
		...
		/**
		 * A simple text input which masks passwords as *
		 */
		PASSWORD, 
