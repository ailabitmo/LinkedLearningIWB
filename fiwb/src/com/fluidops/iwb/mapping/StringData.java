...
public class StringData extends Data
{
	...
	private static final Logger logger = Logger.getLogger(StringData.class.getName());
	...
	public TreeData asXHTML()
	{
		...
		Document doc;
		try {
			doc = tidy.parseDOM(new StringReader(text), null);
		} catch(NullPointerException e) {
			if(text!=null) {
				doc = Tidy.createEmptyDocument();
				logger.warn("Unexpected NullPointerException in jtidy when parsing text as HTML");
