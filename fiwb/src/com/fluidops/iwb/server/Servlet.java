...
//		    String uriHash = (request.getParameter("uri") == null) ? "" : request.getParameter("uri");
	        ...
	        if (activeLabel != null) {
	        	if (activeLabel.equalsIgnoreCase("wiki"))
	        		pc.session.setSessionState("activeLabel", TabWidgetContainer.TAB_WIKI_VIEW);
	        	else if (activeLabel.equalsIgnoreCase("table"))
	        		pc.session.setSessionState("activeLabel", TabWidgetContainer.TAB_TABLE_VIEW);
	        	else if (activeLabel.equalsIgnoreCase("graph"))
	        		pc.session.setSessionState("activeLabel", TabWidgetContainer.TAB_GRAPH_VIEW);
	        	else if (activeLabel.equalsIgnoreCase("pivot"))
	        		pc.session.setSessionState("activeLabel", TabWidgetContainer.TAB_PIVOT_VIEW);
	        }
