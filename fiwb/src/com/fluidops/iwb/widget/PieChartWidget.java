...
public class PieChartWidget extends AbstractChartWidget<PieChartWidget.Config>
{
	...
	public static class Config extends WidgetChartConfig
	{
		...
		public String balloonText = "[[title]]: [[percents]]% ([[value]])\n[[description]]";

        @ParameterConfigDoc(
                desc = "Radius of the pie, in pixels or percents. Default: 50%")
        public String radius;

		@ParameterConfigDoc(
				desc = "Inner radius of the pie, in pixels or percents. Can be used to make the pie chart look as a donut. Default: 0")
	...
	protected FComponent getChart(String id, PieChartWidget.Config config,
        ...
        ChartDataModel pm = ChartWidgetUtil.createChartModel(FChartType.PIE, config.height,
