...
import com.fluidops.iwb.widget.AbstractChartWidget;
 ...
 * instance in the {@link AbstractChartWidget} to specify human-readable
 * names for datasets in the legends.
 * 
...
public class VariableConfig extends BindingBaseConfig {
	...
	@ParameterConfigDoc(desc = "The datatype associated to the given projected value",
