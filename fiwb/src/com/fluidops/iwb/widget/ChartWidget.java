...
public class ChartWidget extends AbstractWidget<ChartWidget.Config>
{
     ...
     */
    protected static final FChartType CHART_TYPE_DEFAULT = FChartType.BAR;
    ...
    public static class Config
    {
    	...
    	@ParameterConfigDoc(
    			...
    			selectValues={"BAR_HORIZONTAL","BAR_VERTICAL","BAR_CLUSTERED",
    	                      "PIE2D", "LINE", "TIME_GRAPH", "MAP"}) 
        public String chart = "BAR_HORIZONTAL"; 
         ...
         */
    	@ParameterConfigDoc(
    			desc = "The chart engine to display the results. Default: AMCHART") 
    ...
    public FComponent getComponent(String id)
    {
        ...
        if (chartType!=FChartType.STOCK)
        {
            try
            {
                 ...
                 */
                if (chartType == FChartType.BAR
                        || chartType == FChartType.COLUMN
                        || chartType == FChartType.PIE)
                {
    ...
    private FChartType strToChartType(String str)
    {
        if (str != null)
        {
            if (str.equals("BAR_HORIZONTAL"))
                return FChartType.BAR;
            if (str.equals("BAR_VERTICAL"))
                return FChartType.COLUMN;
