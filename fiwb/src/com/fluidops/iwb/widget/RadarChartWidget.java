...
public class RadarChartWidget extends AbstractChartWidget<RadarChartWidget.Config>
{
    ...
    public static class Config extends WidgetSerialChartConfig
    {
        ...
        @ParameterConfigDoc(
                desc = "Type of the radar's grid. Default: polygons",
                type = Type.DROPDOWN)
        ...
        @ParameterConfigDoc(
                ...
                type = Type.DROPDOWN,
                defaultValue = "none")
        public BulletType bullet = BulletType.none;
	...
	protected FComponent getChart(String id, RadarChartWidget.Config config,
		...
		if(config.bullet==BulletType.none && StringUtil.isNotNullNorEmpty(config.bulletSize))
		{
