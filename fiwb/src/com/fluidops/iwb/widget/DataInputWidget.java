...
public class DataInputWidget extends AbstractWidget<DataInputWidget.Config>
{
    ...
    public static class Config extends WidgetBaseConfig
    {
    	...
    	@ParameterConfigDoc(
    			...
    			defaultValue="false")
        public Boolean omitDescriptionPage = false;
    	...
    	@ParameterConfigDoc(
    			...
    			defaultValue="false")
        public Boolean idGenerateTriples = false;
        
    	@ParameterConfigDoc(
    			desc = "Saves the type for the object", 
    			defaultValue="true")
        public Boolean idSaveType = true;        
    	...
    	@ParameterConfigDoc(
    			desc = "Rule for building ID (a URI) of id section. Note: a single value reference needs to be enclosed with double quotes, e.g. \"$rdfs:label$\"")
        public String idNameRule;

    	@ParameterConfigDoc(
    			desc = "Rule for constructing label of id section. Note: a single value reference needs to be enclosed with double quotes, e.g. \"$rdfs:label$\"")
    	...
    	@ParameterConfigDoc(
    			...
    			defaultValue="false")
        public Boolean saveCreationDate = false;
        
    	@ParameterConfigDoc(
    			desc = "Save the creator", 
    			defaultValue="false")
        public Boolean saveCreator = false;

    	@ParameterConfigDoc(
    			desc = "Save the last modification date", 
    			defaultValue="false")
        public Boolean saveLastModificationDate = false;
