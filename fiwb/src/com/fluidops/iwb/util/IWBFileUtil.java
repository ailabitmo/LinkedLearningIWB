...
public class IWBFileUtil {
	...
	/**
	 * @return the location of the data dir , i.e. %IWB_HOME%/data/ontologies
	 */
	public static File getOntologiesFolder() {
	    return new File(getIwbWorkingDir(), ONTOLOGY_SUBDIR);
	}
	
	public static File getFileInOntologiesFolder(String fileName) {
		return new File(getOntologiesFolder(), fileName);
	}
